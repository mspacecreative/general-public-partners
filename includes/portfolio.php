...
<div class="gutter-sizer"></div>
	...
	<i class="fa fa-plus"></i>
		<a>
			<img src="<?php echo get_template_directory_uri(); ?>/images/projects/bcc/who-we-are-feature.jpg" alt="Breastfeeding Committee for Canada" />
		</a>
		
		<h4 style="background: <?php the_field('colour_picker', 'options'); ?>">Breastfeeding Committee for Canada</h4>
		<p>Brand / Strategy / Communications Plan / Collateral / Website</p>
		
		<div class="port-panel">
		<div class="close"><img src="<?php echo get_template_directory_uri(); ?>/images/close-button.png" /></div>
			<div class="slider">
			    <div><img src="<?php echo get_template_directory_uri(); ?>/images/projects/bcc/bcc-branding.png" alt="Breastfeeding Committee for Canada" /></div>
			    <div><img src="<?php echo get_template_directory_uri(); ?>/images/projects/bcc/breastfeeding-committee-for-canada-1.jpg" alt="Breastfeeding Committee for Canada" /></div>
			    <div><img src="<?php echo get_template_directory_uri(); ?>/images/projects/bcc/breastfeeding-committee-for-canada-2.jpg" alt="Breastfeeding Committee for Canada" /></div>
			</div>
			<div class="blurb">
				<h3 style="background: <?php the_field('colour_picker', 'options'); ?>">Breastfeeding Committee for Canada</h3><br />
				<h6>Brand / Strategy / Communications Plan / Collateral / Website</h6>
				<p>Our work with the Breastfeeding Committee for Canada began with a brand positioning and identity refresh, followed by the creation of a comprehensive brand book, communications strategy and plan, and a complete redesign of the website. Over the course of 12 months, we guided in the establishment of a brand architecture that hadn’t previously existed, and provided them with the identity, language and tools to generate more effective engagement with their key audiences.</p>
				
				<p><a style="background: <?php the_field('colour_picker', 'options'); ?>" href="https://breastfeedingcanada.ca/" target="_blank">Visit Site</a></p>
			</div>
		</div>
	</div>
	<!-- / BCC -->
	...
	<i class="fa fa-plus"></i>
		<a>
			<img src="<?php echo get_template_directory_uri(); ?>/images/projects/inspiring-communities/inspiring-communities-feature.jpg" alt="Inspiring Communities" />
		</a>
		
		<h4 style="background: <?php the_field('colour_picker', 'options'); ?>">Inspiring Communities</h4>
		<p>Strategy / Design / Video</p>
		
		<div class="port-panel">
		<div class="close"><img src="<?php echo get_template_directory_uri(); ?>/images/close-button.png" /></div>
			<div class="slider gem-slider">
				<iframe id="video-frame-17" src="https://player.vimeo.com/video/383931067?title=0&byline=0" width="640" height="360" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
			</div>
			<div class="blurb">
				<h3 style="background: <?php the_field('colour_picker', 'options'); ?>">Inspiring Communities</h3><br />
				<h6>Strategy / Design / Video</h6>
				<p>Our initial engagement was to create a video highlighting the work undertaken by WeavEast during a 4 day retreat in New Brunswick to explore social innovation and systems change in Atlantic Canada. Following the success of this film, General Public & Partners was engaged to provide ongoing strategic counsel on brand and communications, as well as design and produce the organization’s first impact report.</p>
				
				<p><a style="background: <?php the_field('colour_picker', 'options'); ?>" href="<?php echo get_template_directory_uri(); ?>/images/projects/inspiring-communities/IC_Annual_Report_Digital_Pages.pdf" target="_blank">View Impact Report</a></p>
			</div>
		</div>
	</div>
	<!-- / INSPIRING COMMUNITIES -->
	...
	<i class="fa fa-plus"></i>
		<a>
			<img src="<?php echo get_template_directory_uri(); ?>/images/projects/genome-atlantic/genome-atlantic-covid-19.jpg" alt="Genome Atlantic" />
		</a>
		
		<h4 style="background: <?php the_field('colour_picker', 'options'); ?>">Genome Atlantic</h4>
		<p>Strategy / Video</p>
		
		<div class="port-panel">
		<div class="close"><img src="<?php echo get_template_directory_uri(); ?>/images/close-button.png" /></div>
			<div class="slider gem-slider">
				<iframe id="video-frame-18" src="https://player.vimeo.com/video/423627484?title=0&byline=0" width="640" height="360" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
			 
			    <iframe id="video-frame-19" src="https://player.vimeo.com/video/428684306?title=0&byline=0" width="640" height="360" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
			</div>
			<div class="blurb">
				<h3 style="background: <?php the_field('colour_picker', 'options'); ?>">Genome Atlantic</h3><br />
				<h6>Strategy / Video</h6>
				<p>General Public & Partners began providing strategic counsel to Genome Atlantic in 2019 with a focus on getting maximum value from content distributed on social channels. A shift in strategy to prioritising LinkedIn gained significant engagement in target sectors. The emergence of COVID-19 provided an opportunity to highlight the value of genomes in pandemic monitoring & vaccine development. The videos - also produced in French for Genome Quebec - received considerable media attention.
</p>
			</div>
		</div>
	</div>
